...
<input type="text" name="first_name" id="fn" size ="40" class="form-control form-control-sm mr-1"><br/>
</div>
<div class="form-group col-sm-4">
<label for="ln"><b>Last Name :</b>   </label>
</div>
<div class="form-group col-sm-6">
<input type="text" name="last_name" id="ln" size ="40" class="form-control form-control-sm mr-1"><br/>
</div>
<div class="form-group col-sm-4">
...
<div class="form-group col-sm-6">
<input type="text" name="headline" id="hl" size ="45" class="form-control form-control-sm mr-1" ><br/>
</div>
<div class="form-group col-sm-4">
